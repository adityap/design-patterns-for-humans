...
> Code examples are organized by language and pattern category so implementations can be migrated and tested independently.

Browse the [PHP 7, C#, and Python examples](examples/README.md) by language and pattern category.
